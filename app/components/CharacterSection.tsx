        ...
        >
          <div className="flex-1 pt-[195px] md:pt-[190px] pb-[72px] md:pb-[140px] flex flex-col">
            <Image
              ...
              className={`${
                isScale == 1
                  ? " max-w-[230px] mt-[-20px] sm:mt-auto h-auto sm:max-w-[449px]  sm:max-h-[68px]"
                  : isScale == 2
                  ? " max-w-[230px] mt-[-30px] sm:mt-auto h-auto sm:max-w-[449px]  sm:max-h-[68px]"
                  : isScale == 3
                  ? " max-w-[230px] mt-[-20px] sm:mt-auto h-auto sm:max-w-[449px]  sm:max-h-[68px]"
                  : isScale == 4
                  ? " max-w-[270px] mt-[-40px] sm:mt-[15px] h-auto sm:max-w-[449px]  sm:max-h-[68px]"
                  : "max-w-[270px] mt-[-40px] sm:mt-[15px] h-auto sm:max-w-[449px]  sm:max-h-[68px]"
