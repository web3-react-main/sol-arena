    ...
    >
      <div className=" relative w-full h-[100vh]">
        <div className=" h-[90vh] overflow-hidden object-center relative">
          <Image
            src={"/assets/chill/Art.png"}
            alt=""
            width={1440}
            height={1000}
            className="md:w-[1440px] absolute right-[50%] translate-x-[50%] max-w-[1440px]"
          />
        </div>
        <div
          className=" absolute bottom-0 w-full flex justify-center items-center font-[1000] bg-gradient-to-t from-[#00000000] via-[#051539,#051539,#051539,#051539] to-[#00000020, #00000010, #00000000] text-white md:text-[60px] text-[40px]"
          style={{ textShadow: "0px 0px 40px rgb(255,255,255)" }}
        >
      ...
      <div className=" flex flex-col gap-20 w-full pb-40">
        <div
          className="max-w-[1000px] m-auto text-white flex flex-col gap-12"
        ...
        >
          ...
          <div className=" pl-5 text-[16px]">
            ...
            and real crypto rewards. Easy to pick up and play, it offers casual
            gamers a fun, accessible experience while challenging competitive
            players with depth and strategy. Compete to climb the leaderboards
            by collecting and extracting noCHILL from the Arena while
            representing your favorite crypto communities.
          </div>
        </div>
        <div
          className="max-w-[1000px] m-auto text-white flex flex-col gap-12"
        ...
        >
          ...
          <div className=" pl-5 text-[16px] space-y-8">
            <p>
              We’re trying to build a game that gets better with web3. In our
              opinion, web3 games should have crypto integrated throughout, not
              just a token that is slapped on at the end. This means integrating
              the 2 core values of crypto: networks (community) and
              financialization. Like early Facebook games that were inherently
              social (Farmville), or early mobile games that took advantage of
              the touch screen (Fruit Ninja, Angry Birds), we believe that early
              web3 games need to take advantage of networks (crypto communities)
              and financialization (financial risk/reward).
            </p>

            <p>
              We’ve built these elements into the heart of SOL Arena. Utilizing
              characters and teams sourced directly from the Solana ecosystem,
              crypto wagering that brings the high-stakes thrill of memecoin
              trading, delivered in a simple and easy-to-play snake game with
              proven game mechanics.
            </p>

            <p>
              Our vision is to create a new genre of gaming in web3 that merges
              the thrill and skill of games like poker with the accessibility
              and excitement of modern digital games.
            </p>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className=" pl-5 flex flex-col gap-12">
            <div id="High-Stakes-Gameplay-noCHILL-Crypto-and-Extraction">
              ...
              <div className=" text-[16px] space-y-8">
                <p>
                  ...
                  loop. Players enter the Arena and battle with other players to
                  collect noCHILL, the point scoring system used to climb the
                  leaderboard. To secure their noCHILL onto the leaderboard,
                  players must find and extract through wormholes before other
                  players can take them out and steal it for themselves
                </p>
                ...
                <p>
                  ...
                  Extract with your loot to turn those high-stakes battles into
                  crypto profits.
                </p>
                <div>
                  <Image
                    src={"/assets/chill/image1097.png"}
                    alt=""
                    width={1000}
                    height={1000}
                  />
            ...
            <div id="Community-Driven-Competition-Represent-Your-Coins">
              ...
              <div className=" text-[16px] space-y-8">
                <p>
                  Players join teams to represent real crypto tokens, fostering
                  collaboration and rivalries that add a social and strategic
                  layer to gameplay. By playing for your team, you contribute to
                  its leaderboard rank, building a sense of pride and loyalty
                  while competing for dominance in the Arena.
                </p>
                <div>
                  <Image
                    src={"/assets/chill/image1098.png"}
                    alt=""
                    width={1000}
                    height={1000}
                  />
            ...
            <div id="Accessible-for-All-Rewarding-for-Competitors">
              ...
              <div className=" text-[16px] space-y-8">
                <p>
                  SOL Arena’s simplicity makes it perfect for casual players who
                  enjoy cozy, laid-back gameplay with easy-to-learn mechanics
                  and quick, fun matches. Casual players can farm noCHILL, earn
                  rewards, and collect in-game resources to contribute to the
                  game economy by trading with competitive players.
                </p>
                <p>
          ...
          <div className=" pl-5 text-[16px]">
            <ol className="relative border-s-[2px] border-s-[#5CFFE2]">
              ...
              <li className="mb-10 ms-4">
                ...
                <ul className="pt-6 px-5">
                  <li className="mb-4 text-base font-normal list-disc">
                    Gameplay Polish: Enhanced mechanics and visual improvements
              ...
              <li className="mb-10 ms-4">
                ...
                <ul className="pt-6 px-5">
                  <li className="mb-4 text-base font-normal list-disc">
                    Emotes: Improve in-game communication and social engagement
                    through an emote system
                  </li>
                  <li className="mb-4 text-base font-normal list-disc">
          ...
          <div className=" pl-5 flex flex-col gap-12">
            <div>
              <div className=" text-[16px] space-y-8">
                <div>
                  ...
                  value across our products and brand through entertainment and
                  utility.
                </div>
            ...
            <div id="Tokenomics">
              ...
              <div className=" text-[16px] space-y-8">
                ...
                <div>
                  <Image
                    src={"/assets/chill/image1099.png"}
                    alt=""
                    width={1000}
                    height={1000}
                  />
        ...
        <div className=" w-full relative" id="Who-Are-Your-Partners">
          <Image
            ...
            width={100}
            height={100}
            className=" absolute top-[10%] md:top-[50%] -rotate-45 w-[160px] h-[160px]"
          />
          <Image
            src={"/assets/chill/TokenIcon.png"}
            alt=""
            width={100}
            height={100}
            className=" absolute -rotate-45 top-[20%] md:top-[60%] left-[10%] w-[120px] h-[120px]"
          />
          <Image
            src={"/assets/chill/TokenIcon.png"}
            alt=""
            width={100}
            height={100}
            className=" absolute top-[50%] md:top-[80%] w-[140px] h-[140px] left-[5%]"
          />
          <Image
            src={"/assets/chill/TokenIcon.png"}
            alt=""
            width={100}
            height={100}
            className=" absolute top-[10%] md:top-[60%] right-0 w-[160px] h-[160px]"
          />
          <Image
            src={"/assets/chill/TokenIcon.png"}
            alt=""
            width={100}
            height={100}
            className=" absolute top-[30%] md:top-[80%] right-[8%] -rotate-45 w-[120px] h-[120px]"
          />
          <Image
            src={"/assets/chill/TokenIcon.png"}
            alt=""
            width={100}
            height={100}
            className=" absolute top-[50%] md:top-[90%] right-[4%] w-[120px] h-[120px]"
          />
            ...
            <div className=" pl-5 flex flex-col gap-12">
              ...
              <div>
                <div className=" text-[16px] space-y-8">
                  ...
                  <div>
                    <Image
                      src={"/assets/chill/image1100.png"}
                      alt=""
                      width={1000}
                      height={1000}
                    />
        ...
        >
          ...
          <div className=" pl-5 flex flex-col gap-12">
            <div>
              ...
              <div className=" text-[16px] space-y-8">
                Start playing SOL Arena today at solarena.io on any browser (Mac
                or PC) or through a mobile Solana wallet app. Collect and
                extract noCHILL to climb the leaderboard and qualify for the
                $CHILL airdrop when the token launches.
              </div>
            </div>
          </div>
          <div className=" pl-5 flex flex-col gap-12">
            <div className=" flex flex-col gap-6">
              ...
              <div className=" text-[16px] space-y-8">
                Own a piece of SOL Arena by holding NFTs from the Chillchat
                Origin collection or the upcoming Challenger collection. These
                NFTs not only grant exclusive in-game cosmetics but also
                guarantee your eligibility for the $CHILL airdrop.
              </div>
        ...
        <div
          className="max-w-[1000px] w-full m-auto text-white flex flex-col gap-12"
          id="Links"
        >
          <div className="relative h-fit">
            <Image
          ...
          <div className=" px-5 flex flex-col gap-6">
            <div className=" flex flex-row gap-6">
              <div className="flex-1 md:flex-auto flex flex-row gap-3 items-center md:justify-start justify-between">
                <Image
                  src={"/assets/chill/ButtonIcon-Website.png"}
                  alt=""
                  width={48}
                  height={48}
                />
